import { Component, AsyncComponent, ComponentOptions, FunctionalComponentOptions, WatchOptions, WatchHandler, DirectiveOptions, DirectiveFunction } from "./options";
...
export declare class Vue {
    ...
    $watch(expOrFn: string, callback: WatchHandler<this, any>, options?: WatchOptions): (() => void);
    $watch<T>(expOrFn: (this: this) => T, callback: WatchHandler<this, T>, options?: WatchOptions): (() => void);
